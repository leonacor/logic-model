...
<script>
    ...
    $(document).ready(function(){
            ...
            objResources.setHTML('<?php echo($_SESSION['spr']); ?>','<?php echo($_GET['token']); ?>','<?php echo($_SESSION['nme']); ?>',$('#divHeader'),$('#divFooter'), $('#divBreadcrumbs'), JSON.stringify([{'s':'home.php', 'n': 'inicio'},{'s':'#', 'n': 'ap / ao'},{'s':'#', 'n': 'árbol de problemas'}]));
            getProjects();
        });
...
<section class="w3-center">
    ...
    <br>
    <br>
    <label id="lblProj" class="w3-large">Árbol de problemas</label>
</section>
<br>
<section class="divMiddle w3-center">
    ...
    <div class="w3-row">
        ...
        <div class="w3-container w3-half">
            ...
            <label>Problema central</label>
            <p data-code="Problematica"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter"></div>
    </div>
    <div class="w3-row">
        <div class="w3-container w3-quarter">
            ...
            <label>Causa directa 1</label>
            <p data-code="C1"></p>
        </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-red boxTreeFix boxWrapper caran-hover-rojo-full" onclick="myModalCall(this);">
            <label>Causa directa 2</label>
            <p data-code="C2"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-red boxTreeFix boxWrapper caran-hover-rojo-full" onclick="myModalCall(this);">
            <label>Causa directa 3</label>
            <p data-code="C3"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-red boxTreeFix boxWrapper caran-hover-rojo-full" onclick="myModalCall(this);">
            <label>Causa directa 4</label>
            <p data-code="C4"></p>
            </div>
        </div>
    </div>
    ...
    <div class="w3-row">
        <div class="w3-container w3-quarter">
            ...
            <label>Causa indirecta C1A1</label>
            <p data-code="C1A1"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C2A1</label>
            <p data-code="C2A1"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C3A1</label>
            <p data-code="C3A1"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C4A1</label>
            <p data-code="C4A1"></p>
            </div>
        </div>
    </div>
    <div class="w3-row">
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C1A2</label>
            <p data-code="C1A2"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C2A2</label>
            <p data-code="C2A2"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C3A2</label>
            <p data-code="C3A2"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C4A2</label>
            <p data-code="C4A2"></p>
            </div>
        </div>
    </div>
    <div class="w3-row">
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C1A3</label>
            <p data-code="C1A3"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C2A3</label>
            <p data-code="C2A3"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C3A3</label>
            <p data-code="C3A3"></p>
            </div>
        </div>
        <div class="w3-container w3-quarter">
            <div class="w3-card-4 w3-margin w3-yellow boxTreeFix boxWrapper caran-hover-amarillo-full" onclick="myModalCall(this);">
            <label>Causa indirecta C4A3</label>
            <p data-code="C4A3"></p>
            </div>
        </div>
    </div>
